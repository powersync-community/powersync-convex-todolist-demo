...
export class DemoConnector implements PowerSyncBackendConnector {
  ...
  async uploadData(database: AbstractPowerSyncDatabase): Promise<void> {
    ...
    try {
      // For simplicity, and to avoid extra Convex write pressure in this demo,
      // CRUD operations are uploaded one-by-one. A production connector should
      // consider full transaction consistency for multi-op PowerSync uploads.
