...
/** Connects PowerSync to Convex once an authenticated Convex token is available. */
const AuthAwareSystemProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  }, [authToken, connector, isAuthenticated, isDemoMode]);
...
/** Provides the demo-wide PowerSync, connector, and navigation contexts. */
